...
const TermsAndConditions = () => {
  return (
    <section className="min-h-screen px-6 py-16 max-w-5xl mx-auto bg-base-100 text-base-content">
      <h1 className="text-4xl font-bold text-center mb-8 text-primary">
        Terms & Conditions
      </h1>

      <p className="text-center text-base-content/70 mb-10 max-w-2xl mx-auto">
        By accessing and using CollabEd, you agree to abide by the following terms and conditions.
      </p>
      ...
      <div className="space-y-10">
        ...
        <div>
          ...
          <p>
            ...
            account credentials. You must not engage in activities that disrupt
            or harm other users, the platform, or its content.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            All user-submitted content (e.g., study sessions, materials) remains
            your property, but by uploading, you grant CollabEd a non-exclusive
            license to use it for educational and promotional purposes.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            <a href="mailto:support@collabed.com" className="text-secondary underline">
